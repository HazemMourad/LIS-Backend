...
public class LabtoLabWorksheet {
...
//                appendDefaultContentCharsetToContentTypeIfUndefined(false));
    ...
    public void LabtoLabWorksheet_IgnoreOptional() {
    ...
    public void LabtoLabWorksheet_Validdata() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "2023-08-01");// Example start date
        formData.put("end_date", "2024-03-31");   // Example end date
        formData.put("lab_unit_id", "1");
    ...
    public void LabtoLabWorksheet_Validdata_PDF() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "2023-08-01");// Example start date
        formData.put("end_date", "2024-03-31");   // Example end date
        formData.put("lab_unit_id", "1");
    ...
    public void LabtoLabWorksheet_Validdata_Minimumdate() {
        JSONObject formData = new JSONObject();
    ...
    public void WorkSheetLabToLab_Validdata_Maximumdate() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "1970-01-01");// Example start date
    ...
    public void LabtoLab_Worksheet_Emptydata() {
    ...
    public void postWorksheetLabtoLab_NotcompletedProvidedData() {
    ...
    @Test(description = "Verify that the data is not  retrieved  with Not completed provided data")
    public void postWorksheetLabtoLab_NotcompletedProvidedData_2() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
        formData.put("start_date", "");
    ...
    public void postWorksheetLabtoLab_Invaliddateformat() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
    ...
    public void postWorksheetLabtoLab_Invaliddateformat_EnddatedateBeforeStartDate() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
