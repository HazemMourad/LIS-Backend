...
public class LabtoLabExternalLabarchive {
    ...
    public static final String Endpoint ="/api/V1/reports/lab-to-lab/external-lab-archive";
...
//                appendDefaultContentCharsetToContentTypeIfUndefined(false));
    ...
    public void postExternalLabArchive_Validdata_IgnoreOptional() {
    ...
    public void postExternalLabArchive_Validdata() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "2023-08-01");// Example start date
        formData.put("end_date", "2024-03-31");   // Example end date
    ...
    public void postExternalLabArchive_Validdata_PDF() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "2023-08-01");// Example start date
        formData.put("end_date", "2024-03-31");   // Example end date
        formData.put("lab_id", "1");
    ...
    public void postExternalLabArchive_Validdata_Minimumdate() {
        JSONObject formData = new JSONObject();
    ...
    public void postExternalLabArchive_Validdata_Maximumdate() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "1970-01-01");// Example start date
    ...
    public void postExternalLabArchive_Emptydata() {
    ...
    public void postExternalLabArchive_NotcompletedProvidedData() {
    ...
    @Test(description = "Verify that the data is not  retrieved  with Not completed provided data")
    public void postExternalLabArchive_NotcompletedProvidedData_2() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
        formData.put("start_date", "");
    ...
    public void postExternalLabArchive_Invaliddateformat() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
    ...
    public void postExternalLabArchive_Invaliddateformat_EnddatedateBeforeStartDate() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
