...
public class LabtoLabtransferTest {
    ...
    public static final String Endpoint ="/api/V1/reports/lab-to-lab/lab-transfer-test";
...
//                appendDefaultContentCharsetToContentTypeIfUndefined(false));
    ...
    public void postLabTransferTest_Validdata_IgnoreOptional() {
        ...
        formData.put("lab_id", "");
        formData.put("visit_test_status_id","");
    ...
    public void postLabTransferTest_Validdata() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "2023-08-01");// Example start date
        formData.put("end_date", "2024-03-31");   // Example end date
        formData.put("lab_id", "1");
        formData.put("visit_test_status_id","1");
    ...
    public void postLabTransferTest_Validdata_PDF() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "2023-08-01");// Example start date
        formData.put("end_date", "2024-03-31");   // Example end date
        formData.put("lab_id", "1");
    ...
    public void postLabTransferTest_Validdata_Minimumdate() {
        JSONObject formData = new JSONObject();
    ...
    public void postLabTransferTest_Validdata_Maximumdate() {
        JSONObject formData = new JSONObject();
        Object startDate = formData.put("start_date", "1970-01-01");// Example start date
    ...
    public void postLabTransferTest_Emptydata() {
    ...
    public void postLabTransferTest_NotcompletedProvidedData() {
    ...
    @Test(description = "Verify that the data is not  retrieved  with Not completed provided data")
    public void postLabTransferTest_NotcompletedProvidedData_2() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
        formData.put("start_date", "");
    ...
    public void postLabTransferTest_Invaliddateformat() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
    ...
    public void postLabTransferTest_Invaliddateformat_EnddatedateBeforeStartDate() {
        // Create JSONObject with provided data
        JSONObject formData = new JSONObject();
